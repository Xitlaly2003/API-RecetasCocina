...
exports.signUp = exports.signToken = exports.signIn = exports.getUserInfo = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 19:
          ...
          console.error('Error en el inicio de sesión:', _context2.t0);
          res.status(500).json({
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          token = req.headers.authorization.split(' ')[1]; // Verificar y decodificar el token
          decoded = _jsonwebtoken["default"].verify(token, process.env.SECRET);
          _context3.next = 5;
          return _Users["default"].findById(decoded.id).populate("roles");
        case 5:
          user = _context3.sent;
          if (user) {
            _context3.next = 8;
        ...
        case 8:
          res.json({
            ...
            // Ajusta según cómo guardes los roles
            email: user.email
          });
          _context3.next = 14;
          break;
